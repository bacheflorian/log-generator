...
public class LogControllerTest {
    ...
    public void test_getAllJobMetrics_shouldReturnAllJobMetrics_18() throws Exception {
        ...
        mockMvc.perform(get(metricsUrl)
            ...
            .andExpect(jsonPath("$.batchJobs[:1].startTime", hasItem(equalTo(Integer.valueOf(""+batchMetrics.getStartTime())))))
            .andExpect(jsonPath("$.batchJobs[:1].runTime", hasItem(equalTo(Integer.valueOf(""+batchMetrics.getRunTime())))))
            .andExpect(jsonPath("$.batchJobs[:1].endTime", hasItem(equalTo(Integer.valueOf(""+batchMetrics.getEndTime())))))
            ...
            .andExpect(jsonPath("$.streamJobs[:1].startTime", hasItem(equalTo(Integer.valueOf(""+streamMetrics.getStartTime())))))
            .andExpect(jsonPath("$.streamJobs[:1].runTime", hasItem(equalTo(Integer.valueOf(""+streamMetrics.getRunTime())))))
            .andExpect(jsonPath("$.streamJobs[:1].endTime", hasItem(equalTo(Integer.valueOf(""+streamMetrics.getEndTime())))))
